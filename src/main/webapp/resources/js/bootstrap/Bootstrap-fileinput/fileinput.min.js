...
function(e) {
    ...
    i.prototype = {
            ...
            a = i.taskManager = {
                ...
                TasksPool: function(i) {
                    ...
                    r.run = function(i) {
                        ...
                        c = [],
                        u = e.Deferred();
                        if (r.cancelled) return r.cancelledDeferrer.resolve(),
                        u.reject();
                        if (!i) {
                        ...
                        o = function() {
                            ...
                            return u.notify(e),
                            c.push(e),
                            r.cancelled ? (u.reject.apply(null, c), void r.cancelledDeferrer.resolve()) : (c.length === r.size() && (s ? u.reject.apply(null, c) : u.resolve.apply(null, c)), void(d.length && (a = d.shift(), n(a), a.run())))
                        }; d.length && l++<i;) a = d.shift(),
                        n(a),
                        a.run();
                        return u
                    },
                ...
                Task: function(t, i) {
                    var a = this;
                    a.id = t,
                    a.deferred = e.Deferred(),
                    a.logic = i,
                    a.context = null,
                    a.run = function() {
                        var e = Array.from(arguments);
                        return e.unshift(a.deferred),
                        i.apply(a.context, e),
                        a.deferred
                    },
        ...
        _init: function(i, a) {
            ...
            s.maxTotalFileCount > 0 && s.maxTotalFileCount < s.maxFileCount && (s.maxTotalFileCount = s.maxFileCount),
            ...
            !isNaN(s.maxAjaxThreads) && s.maxAjaxThreads < s.resumableUploadOptions.maxThreads && (s.resumableUploadOptions.maxThreads = s.maxAjaxThreads),
            s._initFileManager(),
            "function" == typeof s.autoOrientImage && (s.autoOrientImage = s.autoOrientImage()),
            "function" == typeof s.autoOrientImageInitial && (s.autoOrientImageInitial = s.autoOrientImageInitial()),
            a || s._cleanup(),
            s.duplicateErrors = [],
            ...
            s.progressPauseTemplate = o.replace("{class}", s.progressPauseClass),
            ...
            s.isAjaxUpload || (s.dropZoneEnabled = s.dropZoneEnabled && t.canAssignFilesToInput()),
            ...
            a ? s._errorsExist() || s.$errorContainer.hide() : (s.$errorContainer.hide(), s.previewInitId = "thumb-" + d.attr("id"), s._initPreviewCache(), s._initPreview(!0), s._initPreviewActions(), s.$parent.hasClass("file-loading") && (s.$container.insertBefore(s.$parent), s.$parent.remove())),
        ...
        _initFileManager: function() {
            ...
            i.fileManager = {
                ...
                getUploadStats: function(e, a, r) {
                    ...
                    return e ? n.stats[e] = p: n.stats = p,
                    p
                },
                exists: function(t) {
                ...
                total: function() {
                    var e = i.fileManager;
                    return e.totalFiles || (e.totalFiles = e.count()),
                    e.totalFiles
                },
                getTotalSize: function() {
                    var t = i.fileManager;
                    return t.totalSize ? t.totalSize: (t.totalSize = 0, e.each(i.fileManager.stack,
                    function(e, i) {
                ...
                move: function(t, a) {
                    var r = {},
                    n = i.fileManager.stack; (t || a) && t !== a && (e.each(n,
                    function(e, i) {
                        e !== t && (r[e] = i),
                        e === a && (r[t] = n[t])
                ...
                list: function() {
                    var t = [];
                    return e.each(i.fileManager.stack,
                    function(e, i) {
                ...
                setProgress: function(e, t) {
                    var a = i.fileManager.getFile(e); ! isNaN(t) && a && (a.progress = t)
                }
            }
        },
        ...
        _initResumableUpload: function() {
            ...
            if (i.enableResumableUpload) {
                if (a.fallback !== !1 && "function" != typeof a.fallback && (a.fallback = function(e) {
                    e._log(r.noResumableSupport),
                    e.enableResumableUpload = !1
                }), !t.hasResumableUploadSupport() && a.fallback !== !1) return void a.fallback(i);
                if (!i.uploadUrl && i.enableResumableUpload) return i._log(r.noUploadUrl),
                ...
                i.resumableManager = {
                    init: function(e, t, a) {
                        ...
                        r.testing = !1,
                        r.lastProgress = 0,
                        i.showPreview && (r.$thumb = n.getThumb(e) || null, r.$progress = r.$btnDelete = null, r.$thumb && r.$thumb.length && (r.$progress = r.$thumb.find(".file-thumb-progress"), r.$btnDelete = r.$thumb.find(".kv-file-remove"))),
                        r.chunkSize = 1024 * i.resumableUploadOptions.chunkSize,
                        r.chunkCount = r.getTotalChunks()
                    },
                    ...
                    upload: function() {
                        ...
                        e = setInterval(function() {
                            ...
                            if (a.checkAborted(e), "new" === o && (i.lock(), o = "processing", l = n.shift(), r.initStats(l), r.stack[l] && (a.init(l, r.stack[l], r.getIndex(l)), a.testUpload(), a.uploadResumable())), !r.isPending(l) && a.completed && (o = "new"), r.isProcessed()) {
                                ...
                                s.length && (t.addCss(s, t.SORT_CSS), i._initSortable()),
                                clearInterval(e),
                                i._clearFileInput(),
                                i.unlock(),
                                setTimeout(function() {
                                    var e = i.previewCache.data;
                                    e && (i.initialPreview = e.content, i.initialPreviewConfig = e.config, i.initialPreviewThumbTags = e.tags),
                                    i._raise("filebatchuploadcomplete", [i.initialPreview, i.initialPreviewConfig, i.initialPreviewThumbTags, i._getExtraData()])
                                },
                                i.processDelay)
                            }
                        },
                    ...
                    uploadResumable: function() {
                        ...
                        n = r.chunkCount;
                        for (t = a.addPool(r.id), e = 0; n > e; e++) r.logs[e] = !(!r.chunksProcessed[r.id] || !r.chunksProcessed[r.id][e]),
                        r.logs[e] || r.pushAjax(e, 0);
                    ...
                    testUpload: function() {
                        ...
                        return u.testUrl ? (c.testing = !0, a = new FormData, r = p.stack[f], i._setUploadData(a, {
                            ...
                            d = i._getOutData(a, e),
                            i._raise("filetestbeforesend", [f, p, c, d])
                        },
                        o = function(r, n, o) {
                            ...
                            u = [f, p, c, d];
                            r[s] && t.isArray(r[s]) ? (c.chunksProcessed[f] || (c.chunksProcessed[f] = {}), e.each(r[s],
                            function(e, t) {
                                c.logs[t] = !0,
                                c.chunksProcessed[f][t] = !0
                            }), c.chunksProcessed[f].data = r, i._raise("filetestsuccess", u)) : i._raise("filetesterror", u),
                            c.testing = !1
                        },
                        l = function(e, t, r) {
                            d = i._getOutData(a, e),
                            i._raise("filetestajaxerror", [f, p, c, d]),
                            c.logAjaxError(e, t, r),
                            c.testing = !1
                        },
                        s = function() {
                            i._raise("filetestcomplete", [f, p, c, i._getOutData(a)]),
                            c.testing = !1
                        },
                    ...
                    pushAjax: function(e, t) {
                        ...
                        function(e) {
                            ...
                            t = a[0],
                            r.chunksProcessed[r.id] && r.chunksProcessed[r.id][t] ? i._log("Could not push task to ajax pool for chunk index # " + t) : r.sendAjax(t, a[1], e)
                        }),
                        r.stack.push([e, t])
                    },
                    sendAjax: function(e, a, n) {
                        ...
                        if (!s.chunksProcessed[u] || !s.chunksProcessed[u][e]) {
                            if (a > d.maxRetries) return n.reject("max try reached"),
                            void s.setProcessed("error");
                            ...
                            s.$progress && s.$progress.length && s.$progress.show(),
                            v = function(r) {
                                h = i._getOutData(m, r),
                                i.showPreview && (f.hasClass("file-preview-success") || (i._setThumbStatus(f, "Loading"), t.addCss(f, "file-uploading")), g.attr("disabled", !0)),
                                i._raise("filechunkbeforesend", [u, e, a, l, s, h])
                            },
                            w = function(t, o, d) {
                            ...
                            b = function(t, r, o) {
                                return i._isAborted() ? void n.reject("cancelling") : (h = i._getOutData(m, t), s.error = o, s.logAjaxError(t, r, o), i._raise("filechunkajaxerror", [u, e, a, l, s, h]), s.pushAjax(e, a + 1), void n.reject("try failed"))
                            },
                            _ = function() {
        ...
        _initTemplateDefaults: function() {
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, h, v, w, b, _, C, y, x, T, P, k, F, E, S, I, A, D, z, M, j, U, $, R, O, B, L, Z, N = this;
            ...
            u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + t.MODAL_ID + 'Label"></div>',
            ...
            Z = '<div class="text-info file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>',
            ...
            x = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-fileid="{fileid}" data-template="{template}"',
            T = x + '><div class="kv-file-content">\n',
            P = x + ' title="{caption}"><div class="kv-file-content">\n',
            k = "</div>{footer}\n</div>\n",
            F = "{content}\n",
            O = " {style}",
            E = '<div class="kv-preview-data file-preview-html" title="{caption}"' + O + ">{data}</div>\n",
            ...
            A = '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}"' + O + "></iframe>",
            D = '<iframe class="kv-preview-data file-preview-gdocs" src="https://docs.google.com/gview?url={data}&embedded=true"' + O + "></iframe>",
            z = '<video class="kv-preview-data file-preview-video" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n",
            ...
            N._isPdfRendered() && ($ = N.pdfRendererTemplate.replace("{renderer}", N._encodeURI(N.pdfRendererUrl))),
            N.defaults = {
                layoutTemplates: {
                    main1: i,
                    main2: a,
            ...
            e.each(N.defaults,
            function(t, i) {
                return "allowedPreviewTypes" === t ? void(void 0 === N.allowedPreviewTypes && (N.allowedPreviewTypes = i)) : void(N[t] = e.extend(!0, {},
                i, N[t]))
            }),
        ...
        _initPreviewTemplates: function() {
            ...
            n = r.tagAfter;
            e.each(a.previewContentTemplates,
            function(e, o) {
        ...
        _initPreviewCache: function() {
            ...
            i.previewCache = {
                ...
                get: function(a, r) {
                    var n, o, l, s, d, c, u, p = t.INIT_FLAG + a,
                    f = i.previewCache.data,
                    g = f.config[a],
                    m = f.content[a],
                    h = t.ifSet("previewAsData", g, i.initialPreviewAsData),
                    v = g ? {
                        title: g.title || null,
                        alt: g.alt || null
                    }: {
                    ...
                    w = function(e, a, r, n, o, l, s, d) {
                        ...
                        u = i.previewInitId + "-" + l,
                        p = g && g.fileId || u;
                        return i._generatePreviewTemplate(e, a, r, n, u, p, !1, null, c, o, l, d, v, g && g.zoomData || a)
                    };
                    return m && m.length ? (r = void 0 === r ? !0 : r, l = t.ifSet("type", g, i.initialPreviewFileType || "generic"), d = t.ifSet("filename", g, t.ifSet("caption", g)), c = t.ifSet("filetype", g, l), s = i.previewCache.footer(a, r, g && g.size || null), u = t.ifSet("frameClass", g), n = h ? w(l, m, d, c, s, p, u) : w("generic", m, d, c, s, p, u, l).setTokens({
                        content: f.content[a]
                    }), f.tags.length && f.tags[a] && (n = t.replaceTags(n, f.tags[a])), t.isEmpty(g) || t.isEmpty(g.frameAttr) || (o = e(document.createElement("div")).html(n), o.find(".file-preview-initial").attr(g.frameAttr), n = o.html(), o.remove()), n) : ""
                },
                clean: function(e) {
                ...
                unset: function(a) {
                    ...
                    if (r) {
                        if (1 === r) return i.previewCache.data.content = [],
        ...
        _validate: function() {
            ...
            return i || e._log(t.logMessages.badInputType),
            i
        },
        ...
        _scanDroppedItems: function(e, i, a) {
            ...
            var r, n, o, l = this,
            s = function(e) {
                l._log(t.logMessages.badDroppedFiles),
                l._log(e)
            };
            e.isFile ? e.file(function(e) {
                a && (e.newPath = a + e.name),
                i.push(e)
            },
        ...
        _zoneDragEnter: function(i) {
            ...
            a.isDisabled || !n ? (i.originalEvent.dataTransfer.effectAllowed = "none", void(i.originalEvent.dataTransfer.dropEffect = "none")) : void(a._raise("fileDragEnter", {
                sourceEvent: i,
                files: r.types.Files
        ...
        _zoneDragLeave: function(e) {
            ...
            t.isDisabled || t._raise("fileDragLeave", {
                sourceEvent: e
        ...
        _clearPreview: function() {
            var i = this,
            a = i.showUploadedThumbs ? i.getFrames(":not(.file-preview-success)") : i.getFrames();
            a.each(function() {
                var a = e(this),
                r = a.attr("id"),
                n = i._getZoom(r);
            ...
            window.KvSortable && 0 !== r.find(n).length && (i = {
                ...
                onSort: function(i) {
                    ...
                    a.getFrames(".file-preview-initial").each(function() {
                        e(this).attr("data-fileindex", t.INIT_FLAG + l),
                        l++
                    }),
                    a._raise("filesorted", {
        ...
        _initPreviewImageOrientations: function() {
            ...
            t.autoOrientImageInitial && t.getFrames(".file-preview-initial").each(function() {
                ...
                l && l.exif && l.exif.Orientation && (n = o.attr("id"), a = o.find(">.kv-file-content img"), r = t._getZoom(n, " >.kv-file-content img"), t.setImageOrientation(a, r, l.exif.Orientation, o)),
                i++
            })
        },
        ...
        _setZoomContent: function(i, a) {
            ...
            f = i.data("size") || "",
            l = p + " " + f,
            v.find(".kv-zoom-title").attr("title", e("<div/>").html(l).text()).html(l),
            s = v.find(".kv-zoom-body"),
            v.removeClass("kv-single-content"),
            a ? (u = s.addClass("file-thumb-loading").clone().insertAfter(s), s.html(o).hide(), u.fadeOut("fast",
            function() {
                s.fadeIn("fast",
                function() {
            ...
            v.data("previewId", m),
            g._handler(v.find(".btn-prev"), "click",
            function() {
                g._zoomSlideShow("prev", m)
            }),
            g._handler(v.find(".btn-next"), "click",
            function() {
            ...
            function() {
                ...
                r = function(e) {
                    ...
                    a = g.zoomModalHeight;
                    v.hasClass("file-zoom-fullscreen") && (a = i.outerHeight(!0), e || (a -= t.outerHeight(!0))),
            ...
            function(t) {
                ...
                o = g.rtl ? 39 : 37,
                l = g.rtl ? 37 : 39;
                i === o && a.length && !a.attr("disabled") && g._zoomSlideShow("prev", n),
                i === l && r.length && !r.attr("disabled") && g._zoomSlideShow("next", n)
            })
        },
        ...
        _zoomSlideShow: function(t, i) {
            ...
            u = d.length;
            if (!s.attr("disabled")) {
                for (r = 0; u > r; r++) n = e(d[r]),
                n && n.length && n.find(".kv-file-zoom:visible").length && c.push(d[r]);
        ...
        _refreshPreview: function() {
            var t, i = this; (i._inputFileCount() || i.isAjaxUpload) && i.showPreview && i.isPreviewable && (i.isAjaxUpload && i.fileManager.count() > 0 ? (t = e.extend(!0, {},
            i.fileManager.stack), i.fileManager.clear(), i._clearFileInput()) : t = i.$element.get(0).files, t && t.length && (i.readFiles(t), i._setFileDropZoneTitle()))
        },
        ...
        _resetPreview: function() {
            var e, t, i = this;
            i.previewCache.count(!0) ? (e = i.previewCache.out(), i._setPreviewContent(e.content), i._setInitThumbAttr(), t = i.initialCaption ? i.initialCaption: e.caption, i._setCaption(t)) : (i._clearPreview(), i._initCaption()),
        ...
        _initXhr: function(e, i, a) {
            ...
            o = function(e) {
                ...
                e.lengthComputable && !r.enableResumableUpload && (o = t.round(s / l * 100)),
                i ? r._setFileUploadStats(i, o, a, d) : r._setProgress(o, null, null, r._getStats(d)),
                r._raise("fileajaxprogress", [d])
            };
            return e.upload && (r.progressDelay && (o = t.debounce(o, r.progressDelay)), e.upload.addEventListener("progress", o, !1)),
            e
        },
        ...
        _ajaxSubmit: function(t, i, a, r, n, o, l, s) {
            ...
            d = e.extend(!0, {},
            c, f._ajaxSettings), p = f.taskManager.addTask(o + "-" + l,
            function() {
                var t, i, a = this.self;
                t = a.ajaxQueue.shift(),
                i = e.ajax(t),
        ...
        _initUploadSuccess: function(i, a, r) {
            ...
            return ! m.showPreview || "object" != typeof i || e.isEmptyObject(i) ? void m._resetCaption() : (void 0 !== i.initialPreview && i.initialPreview.length > 0 && (m.hasInitData = !0, c = i.initialPreview || [], u = i.initialPreviewConfig || [], p = i.initialPreviewThumbTags || [], n = void 0 === i.append || i.append, c.length > 0 && !t.isArray(c) && (c = c.split(m.initialPreviewDelimiter)), c.length && (m._mergeArray("initialPreview", c), m._mergeArray("initialPreviewConfig", u), m._mergeArray("initialPreviewThumbTags", p)), void 0 !== a ? r ? (f = a.attr("id"), g = m._getUploadCacheIndex(f), null !== g && (m.uploadCache[g] = {
                ...
                tags: p[0] || [],
                append: n
            })) : (l = m.previewCache.add(c[0], u[0], p[0], n), o = m.previewCache.get(l, !1), s = e(document.createElement("div")).html(o).hide().insertAfter(a), d = s.find(".kv-zoom-cache"), d && d.length && d.insertAfter(a), a.fadeOut("slow",
            function() {
                var e = s.find(".file-preview-frame");
                e && e.length && e.insertBefore(a).fadeIn("slow").css("display:inline-block"),
                m._initPreviewActions(),
                m._clearFileInput(),
                t.cleanZoomCache(m._getZoom(a.attr("id"))),
                a.remove(),
                s.remove(),
                m._initSortable()
        ...
        _uploadSingle: function(i, a, r) {
            ...
            w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(k) || (v = function() {
                c ? b.errors.push(a) : b.removeFile(a),
                b.setProcessed(a),
                b.isProcessed() && (w.fileBatchCompleted = !0)
            },
            l = function() {
                var e;
            ...
            p = function(l) {
                ...
                r || (w.ajaxAborted = !1),
                w.showPreview && (o.hasClass("file-preview-success") || (w._setThumbStatus(o, "Loading"), t.addCss(o, "file-uploading")), s.attr("disabled", !0), d.attr("disabled", !0)),
                r || w.lock(),
                -1 !== b.errors.indexOf(a) && delete b.errors[a],
                w._raise("filepreupload", [n, y, i]),
                e.extend(!0, k, n),
                w._abort(k) && (l.abort(), r || (w._setThumbStatus(o, "New"), o.removeClass("file-uploading"), s.removeAttr("disabled"), d.removeAttr("disabled"), w.unlock()), w._setProgressCancelled())
            },
            g = function(l, d, p) {
            ...
            m = function() {
                setTimeout(function() {
                    w.showPreview && (s.removeAttr("disabled"), d.removeAttr("disabled"), o.removeClass("file-uploading")),
            ...
            C.append(w.uploadFileAttr, P.file, F), w._setUploadData(C, {
                fileId: a
        ...
        _uploadBatch: function() {
            ...
            if (0 !== c && p && !s._abort(u)) {
                ...
                i = function(i) {
                    ...
                    s.ajaxAborted = !1,
                    s.showPreview && s._getThumbs().each(function() {
                        var i = e(this),
                        a = i.find(".kv-file-upload"),
                        r = i.find(".kv-file-remove");
                        i.hasClass("file-preview-success") || (s._setThumbStatus(i, "Loading"), t.addCss(i, "file-uploading")),
                        a.attr("disabled", !0),
                        r.attr("disabled", !0)
                    }),
                    s._raise("filebatchpreupload", [a]),
                    s._abort(a) && (i.abort(), s._getThumbs().each(function() {
                        var t = e(this),
                        i = t.find(".kv-file-upload"),
                        a = t.find(".kv-file-remove");
                        t.hasClass("file-preview-loading") && (s._setThumbStatus(t, "New"), t.removeClass("file-uploading")),
                ...
                a = function(i, a, r) {
                    ...
                    t.isEmpty(i) || t.isEmpty(i.error) ? (s._raise("filebatchuploadsuccess", [n]), l(), s.showPreview ? (c.each(function() {
                        ...
                        0 === u.length || -1 !== e.inArray(d, u) ? (s._setPreviewError(t, !0), s.retryErrorUploads || (t.find(".kv-file-upload").hide(), s.fileManager.remove(t))) : (t.find(".kv-file-upload").hide(), s._setThumbStatus(t, "Success"), s.fileManager.remove(t)),
                        t.hasClass("file-preview-error") && !s.retryErrorUploads || d++
                ...
                n = function() {
                    ...
                    s._clearFileInput(),
                    s._raise("filebatchuploadcomplete", [s.fileManager.stack, s._getExtraData()])
                },
                r = function(t, i, a) {
                    ...
                    s.showPreview && (s._getThumbs().each(function() {
                        var t = e(this);
                        t.removeClass("file-uploading"),
                        s.fileManager.getFile(t.attr("data-fileid")) && s._setPreviewError(t)
                ...
                var m = 0;
                e.each(s.fileManager.stack,
                function(e, i) {
                    t.isEmpty(i.file) || f.append(s.uploadFileAttr, i.file, i.nameFmt || "untitled_" + m),
                    m++
                }),
        ...
        _uploadExtraOnly: function() {
            ...
            r = function(e, t, i) {
                ...
                o._setProgress(101, o.$progress, o.msgAjaxProgressError.replace("{operation}", d))
            },
        ...
        _initFileActions: function() {
            ...
            i.showPreview && (i._initZoomButton(), i.getFrames(" .kv-file-remove").each(function() {
                ...
                i._handler(n, "click",
                function() {
                    return r = i._raise("filepreremove", [l, s]),
                    r !== !1 && i._validateMinCount() ? (a = o.hasClass("file-preview-error"), t.cleanMemory(o), void o.fadeOut("slow",
                    function() {
                        t.cleanZoomCache(i._getZoom(l)),
                        i.fileManager.remove(o),
                        i._clearObjects(o),
                        o.remove(),
                        l && a && i.$errorContainer.find('li[data-thumb-id="' + l + '"]').fadeOut("fast",
                        function() {
                            e(this).remove(),
                ...
                function() {
                    ...
                    i._hideProgress(),
                    e.hasClass("file-preview-error") && !i.retryErrorUploads || i._uploadSingle(i.fileManager.getIndex(r), r, !1)
                })
            }))
        },
        _initPreviewActions: function() {
            ...
            a.find(n).each(function() {
                ...
                if (!t.isEmpty(p) && void 0 !== f) {
                    ...
                    v = t.isEmpty(C.config) && t.isEmpty(C.config[y]) ? null: C.config[y],
                    b = t.isEmpty(v) || t.isEmpty(v.extra) ? r: v.extra,
                    w = v.filename || v.caption || "",
                    ...
                    n = function(e) {
                        ...
                        i._abort() ? e.abort() : (u.removeClass(s), t.addCss(_, "file-uploading"), t.addCss(u, "disabled " + l))
                    },
                    o = function(e, r, n) {
                        var o, c;
                        return t.isEmpty(e) || t.isEmpty(e.error) ? (_.removeClass("file-uploading").addClass("file-deleted"), void _.fadeOut("slow",
                        function() {
                            y = parseInt(_.attr("data-fileindex").replace(t.INIT_FLAG, "")),
                            ...
                            t.cleanZoomCache(i._getZoom(_.attr("id"))),
                            i._clearObjects(_),
                            _.remove(),
                            d()
        ...
        _generatePreviewTemplate: function(i, a, r, n, o, l, s, d, c, u, p, f, g, m) {
            ...
            I = E ? "other": i;
            return v = 400 > x ? b.previewSettingsSmall[I] || b.defaults.previewSettingsSmall[I] : b.previewSettings[I] || b.defaults.previewSettings[I],
            v && e.each(v,
            function(e, t) {
                y += e + ":" + t + ";"
            }),
            w = function(a, s, d, u) {
                ...
                v = (c || "") + " " + u;
                return b.frameClass && (v = b.frameClass + " " + v),
                d && (v = v.replace(" " + t.SORT_CSS, "")),
                h = b._parseFilePreviewIcon(h, r),
                "text" === a && (s = t.htmlEncode(s)),
                "object" !== i || n || e.each(b.defaults.fileTypeSettings,
                function(e, t) {
                    "object" !== e && "other" !== e && t(r, n) && (k = "type-" + e)
                }),
                t.isEmpty(g) || (void 0 !== g.title && null !== g.title && (T = g.title), void 0 !== g.alt && null !== g.alt && (T = g.alt)),
                h.setTokens({
                    previewId: m,
                    caption: _,
                    title: T,
            ...
            b.fileActionSettings.showZoom && (C = w(S ? "other": i, m ? m: a, !0, "kv-zoom-thumb")),
        ...
        _previewDefault: function(e, i) {
            ...
            if (a.showPreview) {
                ...
                i === !0 && a.isAjaxUpload && a._setThumbStatus(a._getFrame(f), "Error")
            }
        },
        _previewFile: function(e, i, a, r, n) {
            if (this.showPreview) {
                ...
                h = l._getThumbId(m);
                "html" === u && l.purifyHtml && window.DOMPurify && (g = window.DOMPurify.sanitize(g)),
        ...
        _updateFileDetails: function(e, i) {
            ...
            d = s.$element,
            c = t.isIE(9) && t.findFileName(d.val()) || d[0].files[0] && d[0].files[0].name; ! c && s.fileManager.count() > 0 ? (l = s.fileManager.getFirstFile(), a = l.nameFmt) : a = c ? s.slug(c) : "_",
            r = s.isAjaxUpload ? s.fileManager.count() : e,
            o = s.previewCache.count(!0) + r,
            n = 1 === r ? a: s._getMsgSelected(o),
            s.isError ? (s.$previewContainer.removeClass("file-thumb-loading"), s.$previewStatus.html(""), s.$captionContainer.removeClass("icon-visible")) : s._showFileIcon(),
        ...
        _setProgress: function(e, i, a, r) {
            ...
            if (i = i || n.$progress, i.length) {
                ...
                e >= 100 && (r = ""),
                t.isEmpty(c) || (o = s && l > s && 100 >= e ? c.setTokens({
                    percent: s,
                    ...
                    stats: r
                }), i.html(o), a && i.find('[role="progressbar"]').html(a))
            }
        },
        _setFileDropZoneTitle: function() {
            ...
            !i.showPreview || 0 === a.length || i.fileManager.count() > 0 || !i.dropZoneEnabled || !i.isAjaxUpload && i.$element.files || (0 === a.find(t.FRAMES).length && t.isEmpty(i.defaultPreviewContent) && a.prepend('<div class="' + i.dropZoneTitleClass + '">' + r + "</div>"), i.$container.removeClass("file-input-new"), t.addCss(i.$container, "file-input-ajax-new"))
        },
        ...
        _setFileUploadStats: function(i, a, r, n) {
            ...
            if (o.showPreview || l && l.length) {
                ...
                if (o.enableResumableUpload) {
                    ...
                    a = t.round(100 * h / w),
                    n.pendingBytes = w - v,
                    o._setResumableProgress(a, n, c),
                    s = Math.floor(100 * m / f),
                    g.pendingBytes = f - m,
                    o._setResumableProgress(s, g)
                } else d.setProgress(i, a),
                l = c && c.length ? c.find(".file-thumb-progress") : null,
                o._setProgress(a, l, null, o._getStats(n)),
                e.each(d.stats,
                function(e, t) {
                    p += t.loaded
                }),
                g.pendingBytes = f - p,
                s = t.round(p / f * 100),
                o._setProgress(s, null, null, o._getStats(g))
            }
        },
        ...
        _getFileCount: function(e, t) {
            var i = this,
            a = 0;
            return void 0 === t && (t = i.validateInitialCount && !i.overwriteInitial),
        ...
        _setPreviewError: function(e, t) {
            ...
            if (t && !a || i.fileManager.remove(e), i.showPreview) {
                ...
                i._setThumbStatus(e, "Error"),
                i._refreshUploadButton(e)
            }
        },
        ...
        _checkDimensions: function(e, i, a, r, n, o, l) {
            var s, d, c, u, p = this,
            f = "Small" === i ? "min": "max",
            g = p[f + "Image" + o]; ! t.isEmpty(g) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width: c.naturalHeight || c.height, u = "Small" === i ? d >= g: g >= d, u || (s = p["msgImage" + o + i].setTokens({
                name: n,
                size: g
        ...
        setImageOrientation: function(i, a, r, n) {
            ...
            c && u || (s = "load.fileinputimageorient", f ? (i = a, a = null, i.css(d.previewSettings.image), l = e(document.createElement("div")).appendTo(n.find(".kv-file-content")), o = e(document.createElement("span")).insertBefore(i), i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(l)) : p = !i.is(":visible"), i.off(s).on(s,
            function() {
                p && (d.$preview.removeClass("hide-content"), n.find(".kv-file-content").css("visibility", "hidden"));
                var e = i.get(0),
                s = a && a.length ? a.get(0) : null,
                c = e.offsetHeight,
                u = e.offsetWidth,
                g = t.getRotation(r);
                if (p && (n.find(".kv-file-content").css("visibility", "visible"), d.$preview.addClass("hide-content")), i.data("orientation", r), s && a.data("orientation", r), 5 > r) return t.setTransform(e, g),
                void t.setTransform(s, g);
                var m = Math.atan(u / c),
                ...
                f && (i.css("visibility", "visible").insertAfter(o).addClass("file-zoom-detail"), o.remove(), l.remove())
            }))
        },
        _validateImageOrientation: function(i, a, r, n, o, l, s, d) {
            var c, u, p = this,
            f = p.autoOrientImage,
            g = t.getZoomSelector(r, " img");
            return c = f ? p._getExifObj(d) : null,
            (u = c ? c["0th"][piexif.ImageIFD.Orientation] : null) ? (p.setImageOrientation(i, e(g), u, p._getFrame(r)), p._raise("fileimageoriented", {
                $img: i,
                file: a
        ...
        _validateImage: function(t, i, a, r, n, o, l) {
            ...
            function() {
                ...
                u.resizeImage || (u._checkDimensions(g, "Large", m, f, a, "Width", s), u._checkDimensions(g, "Large", m, f, a, "Height", s)),
        ...
        _validateAllImages: function() {
            ...
            r === i.fileManager.totalImages && (i._raise("fileimagesloaded"), i.resizeImage && e.each(i.fileManager.loadedImages,
            function(e, o) {
        ...
        _getResizedImage: function(i, a, r, n) {
            ...
            m = [i, F, E], (!f || !x || C >= w && y >= b) && (x && f && h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized"), !x)) return void c(h.msgImageResizeError, g, "fileimageresizeerror");
            k = k || h.resizeDefaultImageType,
            l = w > C,
            s = b > y,
            _ = "width" === h.resizePreference ? l ? C / w: s ? y / b: 1 : s ? y / b: l ? C / w: 1,
            h._resetCanvas(),
            w *= _,
            b *= _,
            T.width = w,
            ...
            try {
                ...
                o instanceof Blob || c(h.msgImageResizeError, g, "fileimageresizeerror")
            } catch(A) {
                r.val++,
                r.val === n && h._raise("fileimagesresized", [void 0, void 0]),
        ...
        _initClickable: function() {
            var i, a, r = this;
            r.isClickable && (i = r.$dropZone, r.isAjaxUpload || (a = r.$preview.find(".file-default-preview"), a.length && (i = a)), t.addCss(i, "clickable"), i.attr("tabindex", -1), r._handler(i, "click",
            function(t) {
                var a = e(t.target);
        ...
        _setCaption: function(i, a) {
            ...
            if (c.$caption.length) {
                if (c.$captionContainer.removeClass("icon-visible"), a) r = e("<div>" + c.msgValidationError + "</div>").text(),
                l = c.fileManager.count(),
                l ? (d = c.fileManager.getFirstFile(), s = 1 === l && d ? d.nameFmt: c._getMsgSelected(l)) : s = c._getMsgSelected(c.msgNo),
                n = t.isEmpty(i) ? s: i,
        ...
        _renderFileFooter: function(e, i, a, r, n) {
            ...
            s.isAjaxUpload ? (l.progress = s._renderThumbProgress(), l.actions = s._renderFileActions(l, p, !1, c, f, u, !1, !1, !1)) : l.actions = s._renderFileActions(l, !1, !1, !1, f, u, !1, !1, !1),
            o = g.setTokens(l),
        ...
        _change: function(i) {
            ...
            if (!a.changeTriggered) {
                ...
                }] : [] : i.target.files || {}), r = u, t.isEmpty(r) || 0 === r.length) return c || a.clear(),
        ...
        _abort: function(t) {
            ...
            a._getOutData(null), t), i.abortData = a.ajaxAborted.data || {},
            i.abortMessage = a.ajaxAborted.message, a._setProgress(101, a.$progress, a.msgCancelled), a._showFileError(a.ajaxAborted.message, i, "filecustomerror"), a.cancel(), !0) : !!a.ajaxAborted
        },
        ...
        _isFileSelectionValid: function(e) {
            var t = this;
            return e = e || 0,
            t.required && !t.getFilesCount() ? (t.$errorContainer.html(""), t._showFileError(t.msgFileRequired), !1) : t.minFileCount > 0 && t._getFileCount(e) < t.minFileCount ? (t._noFilesError({}), !1) : !0
        },
        _canPreview: function(e) {
            ...
            return a = !u || -1 !== u.indexOf(c),
            r = !p || -1 !== p.indexOf(s),
            n = !f.length || t.compare(l, w),
            o = g && -1 !== g.indexOf(c) || m && -1 !== m.indexOf(s) || h.length && t.compare(l, b) || v && !isNaN(v) && d > v,
            !o && (a || r || n)
        },
        ...
        getFilesCount: function(e) {
            ...
            return e && (i += t.previewCache.count(!0)),
            t._getFileCount(i)
        },
        readFiles: function(i) {
            ...
            v = function(t, n, o, l, s, d) {
                ...
                d = d || r.removeFromPreviewOnError,
                d || r._previewDefault(n, !0),
                c = r._getFrame(o, !0),
                r.isAjaxUpload ? setTimeout(function() {
                    a(l + 1)
                },
                r.processDelay) : (r.unlock(), u = 0),
                d && c.length ? c.remove() : (r._initFileActions(), c.find(".kv-file-upload").remove()),
                r.isError = r.isAjaxUpload ? r._showFileError(t, p) : r._showError(t, f),
            ...
            a = function(w) {
                ...
                C = r.fileManager;
                if (w >= u) return r.unlock(),
                r.duplicateErrors.length && (b = "<li>" + r.duplicateErrors.join("</li><li>") + "</li>", 0 === _.find("ul").length ? _.html(r.errorCloseButton + "<ul>" + b + "</ul>") : _.find("ul").append(b), _.fadeIn(r.fadeDelay), r._handler(_.find(".kv-error-close"), "click",
                function() {
                ...
                K = function() {
                    ...
                    r.processDelay),
                    r._raise("fileloaded", [U, $, w, n]) && r.isAjaxUpload && C.add(U)
                };
                if (U) {
                    if (S = C.getId(U), g > 0) for (x = 0; g > x; x++) F = f[x],
                    E = r.msgFileTypes[F] || F,
                    q += 0 === x ? E: ", " + E;
                    if (L === !1) return void a(w + 1);
                    if (0 === L.length) return T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(U), "[unknown]")),
                    void v(T, U, $, w, S);
                    if (t.isEmpty(m) || (N = new RegExp("\\.(" + m.join("|") + ")$", "i")), y = Z.toFixed(2), r.isAjaxUpload && C.exists(S) || r._getFrame($, !0).length) {
                        var G = {
                            id: $,
                            index: w,
                            fileId: S,
                        ...
                        void(r.isAjaxUpload ? setTimeout(function() {
                            ...
                            r._raise("fileduplicateerror", [U, S, L, y, $, w]),
                            a(w + 1),
                            r._updateFileDetails(u)
                        },
                        r.processDelay) : (r._showError(T, G), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                    }
                    if (r.maxFileSize > 0 && Z > r.maxFileSize) return T = r.msgSizeTooLarge.setTokens({
                        name: L,
                        size: y,
                        maxSize: r.maxFileSize
                    }),
                    void v(T, U, $, w, S);
                    if (null !== r.minFileSize && Z <= t.getNum(r.minFileSize)) return T = r.msgSizeTooSmall.setTokens({
                        name: L,
                        size: y,
                    ...
                    if (!t.isEmpty(f) && t.isArray(f)) {
                        for (x = 0; x < f.length; x += 1) P = f[x],
                        A = p[P],
                        W += A && "function" == typeof A && A(U.type, t.getFileName(U)) ? 1 : 0;
                    ...
                    if (0 === W && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(N) && (k = t.compare(L, N), W += t.isEmpty(k) ? 0 : k.length, 0 === W)) return T = r.msgInvalidFileExtension.setTokens({
                        name: L,
                        extensions: h
                    }),
                    void v(T, U, $, w, S);
                    if (!r._canPreview(U)) return I = r.isAjaxUpload && r._raise("filebeforeload", [U, w, n]),
                    r.isAjaxUpload && I && C.add(U),
                    r.showPreview && I && (o.addClass("file-thumb-loading"), r._previewDefault(U), r._initFileActions()),
                    void setTimeout(function() {
                        I && r._updateFileDetails(u),
                        a(w + 1),
                        r._raise("fileloaded", [U, $, w])
                    },
                    10);
                    D = R(U.type, L),
                    z = B(U.type, L),
                    ...
                    n.onload = function(i) {
                        ...
                        f = function(e) {
                            ...
                            t.onload = function(e) {
                                r.isAjaxUpload && !r._raise("filebeforeload", [U, w, n]) || (r._previewFile(w, U, e, H, o), r._initFileActions(), K())
                            },
                        ...
                        e.each(p,
                        function(e, t) {
                            "object" !== e && "other" !== e && "function" == typeof t && t(U.type, L) && V++
                        }), 0 === V) {
                            for (l = new Uint8Array(i.target.result), x = 0; x < l.length; x++) s = l[x].toString(16),
                            u.push(s);
                            if (a = u.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(n.result), c = t.isSvg(d) ? "image/svg+xml": t.getMimeType(a, d, U.type)), o = {
                                name: L,
                                type: c
                            },
                            D = R(c, ""), z = B(c, ""), M = O(c, ""), j = D || z, j || M) return void f(j)
                        }
                        r.isAjaxUpload && !r._raise("filebeforeload", [U, w, n]) || (r._previewFile(w, U, i, H, o), r._initFileActions(), K())
                    },
        ...
        pause: function() {
            ...
            if (d && d.cancel(), i._raise("fileuploadpaused", [i.fileManager, a]), n > 0) for (t = 0; n > t; t += 1) i.paused = !0,
            r[t].abort();
            return i.showPreview && i._getThumbs().each(function() {
                ...
                s.attr("title") === l.indicatorLoadingTitle && (i._setThumbStatus(a, "Paused"), t = n.setTokens({
                    pendingTime: i.msgPaused,
                    uploadSpeed: ""
                }), i.paused = !0, i._setProgress(o, a.find(".file-thumb-progress"), o + "%", t)),
                i.fileManager.getFile(r) || a.find(".kv-file-remove").removeClass("disabled").removeAttr("disabled")
            }),
        ...
        cancel: function() {
            ...
            }), r.reset(), i._raise("fileuploadcancelled", [i.fileManager, r])) : i._raise("fileuploadcancelled", [i.fileManager]), i._initAjax(), l > 0) for (t = 0; l > t; t += 1) i.cancelling = !0,
            a[t].abort();
            return i._getThumbs().each(function() {
                var t = e(this),
                ...
                i._setProgress(0, r),
                r.hide(),
                i.fileManager.getFile(a) || (t.find(".kv-file-upload").removeClass("disabled").removeAttr("disabled"), t.find(".kv-file-remove").removeClass("disabled").removeAttr("disabled")),
                i.unlock()
            }),
            setTimeout(function() {
                i._setProgressCancelled()
        ...
        reset: function() {
            var e = this;
            if (e._raise("filereset")) return e.lastProgress = 0,
            e._resetPreview(),
        ...
        upload: function() {
            ...
            if (r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(o)) return r.lastProgress = 0,
            r._resetUpload(),
            0 !== o || l ? (r.cancelling = !1, r._showProgress(), r.lock(), 0 === o && l ? (r._setProgress(2), void r._uploadExtraOnly()) : r.enableResumableUpload ? r.resume() : ((r.uploadAsync || r.enableResumableUpload) && (a = r._getOutData(null), r._raise("filebatchpreupload", [a]), r.fileBatchCompleted = !1, r.uploadCache = [], e.each(r.getFileStack(),
            function(e) {
            ...
            }), r.$preview.find(".file-preview-initial").removeClass(t.SORT_CSS), r._initSortable()), r._setProgress(2), r.hasInitData = !1, r.uploadAsync ? (i = 0, void e.each(n.stack,
            function(e) {
                r._uploadSingle(i, e, !0),
                i++
    ...
    e.fn.fileinput = function(a) {
        if (t.hasFileAPISupport() || t.isIE(9)) {
            ...
            switch (r.shift(), this.each(function() {
                ...
                s || (c && (p = e.fn.fileinputThemes[c] || {}), "en" === f || t.isEmpty(e.fn.fileinputLocales[f]) || (u = e.fn.fileinputLocales[f] || {}), o = e.extend(!0, {},
                e.fn.fileinput.defaults, p, e.fn.fileinputLocales.en, u, d, l.data()), s = new i(this, o), l.data("fileinput", s)),
    ...
    e.fn.fileinput.defaults = {
        ...
        sanitizeZoomCache: function(t) {
            ...
            return i.find("input,select,.file-thumbnail-footer").remove(),
            i.html()
        },
